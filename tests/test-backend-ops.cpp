...
static std::vector<std::unique_ptr<test_case>> make_test_cases_perf() {
 ...
 // High resolution output (large NPQ)
    ...
    // Qwen3.5-2B Q4_0 MMV shapes for decoding (n=1). Weight (k, m) layout, i.e. K=2048 input.
    // attn_qkv / ffn_gate / ffn_up output 6144 (3x per block); attn_output outputs 2048 (1x).
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q4_0, GGML_TYPE_F32, 6144, 1,   2048, {1, 1}, {1, 1}));
    test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q4_0, GGML_TYPE_F32, 2048, 1,   2048, {1, 1}, {1, 1}));
